...
import { Play, Code, Palette, Cpu, Headphones } from "lucide-react";
      ...
      <div className="showreel-content">
        <div className="showreel-content-container" >
          ...
          <div ref={videoRef} className="showreel-content-videobox" >
            ...
            <video src="/videos/animacion.mp4" className="showreel-content-video" autoPlay="autoplay" muted playsInline={true} data-wf-ignore="true" preload="auto" loop />
          </div>
        </div>
        <div className="showreel-content-row">
          <div className="showreel-content-row-item opacity-blur" ref={showreelItemRef1} >
            <div className="showreel-content-row-item-content">
              <img src="/logos/desarrollo.png" className="showreel-content-row-item-image" alt="" />
            </div>
            <div className="showreel-content-row-item-grid" />
          </div>
          <div className="showreel-content-row-item opacity-blur" ref={showreelItemRef2} >
            <div className="showreel-content-row-item-content">
              <img src="/logos/diseno_moderno.png" className="showreel-content-row-item-image" alt="" />
            </div>
            <div className="showreel-content-row-item-grid" />
          </div>
          <div className="showreel-content-row-item opacity-blur" ref={showreelItemRef3} >
            <div className="showreel-content-row-item-content">
              <img src="/logos/tecnologia.png" className="showreel-content-row-item-image" alt="" />
            </div>
            <div className="showreel-content-row-item-grid" />
          </div>
          <div className="showreel-content-row-item opacity-blur" ref={showreelItemRef4} >
            <div className="showreel-content-row-item-content">
              <img src="/logos/soporte.png" className="showreel-content-row-item-image" alt="" />
            </div>
            <div className="showreel-content-row-item-grid" />
          </div>
        </div>
